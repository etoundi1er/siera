...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "Siera web application."
  #
  #
  ...
  #
  # settings.secret_key_base= fMeOjGLD3pTDK5TCCOKbE6hwGuliSj6SiGDF2swSsdg
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("siera.log", "w"))
  #
  #
end
